...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/VK Chain Block.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/VK Chain Block.data.unityweb',
                        frameworkUrl: 'Build/VK Chain Block.framework.js.unityweb',
                        codeUrl: 'Build/VK Chain Block.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'Unity_CubesGame-master',
                        productVersion: '1.0',
